function head = arrow(arrow_front,arrow_tail,length)
...
angle_x = atan2(det([[arrow_direction(1);arrow_direction(2)],reference]),dot([arrow_direction(1);arrow_direction(2)],reference));
...
R_z3=[cos(3*pi/2),sin(3*pi/2),0;sin(-3*pi/2),cos(3*pi/2),0;0,0,1];
