  ...
  class NullLoop : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->model = _parent;
        ...
        if (aveDist_ < 1.5* 0.02){
          frequenz_ = 0.5*frequenz_;
          aveDist_ =  vel_ / frequenz_ / 0.02; 
        }
       ...
       gazebo::common::PoseAnimationPtr anim(
              ...
              new gazebo::common::PoseAnimation("test", 0.02*lengthFields/ vel_, true));
        ...
        while(openLoop){
          ...
          if (startValue_ - lengthFields > nextIdx_){
            openLoop = false;
            curIdx_ = startValue_;
          ...
          if (nextIdx_ < 0){
            nextIdx_ = lengthFields + ( nextIdx_);
          }
          if (curIdx_ <0){
            curIdx_ = lengthFields + (curIdx_);
          }
          // determine values
