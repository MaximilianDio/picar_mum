class VelocityPicker(object):
    ...
    def __init__(self, vel_mix, vel_max, switch_bound_slope, switch_bound_radius):
        ...
        Returns:
        """
        self.number_avg = 1  # number of stored values for radii estimation
    ...
    def moving_average(self, curve_point):
        ...
        return [sum(self.ave_list[0]) / len(self.ave_list[0]),
                sum(self.ave_list[1]) / len(self.ave_list[1])]  # average slop and radius
